            ...
            <nav class="top-toolbar">
                <div>
                    <table cellpadding="5" cellspacing="0">
                        <tr>
                            <td><a class="navbar-brand navsel" href="../index.php"><img src="../images/logo.jpg" alt="Quizzer logo" width="100" height="50"></a></td>
                    
                            <td><a class="navsel" href="index.php">Home</a></td>
                            <?php
